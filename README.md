...
<img src="host_child.png" width="80%">
...
## Contents of this repostory
This repository contains a 'host' and a 'child' folder.

### Host folder
The 'host' folder contains contains example code that needs to be added to the websites that embed the iframe.
...
#### twc-host-styles.css 
Contains styles to properly style the iFrame, depending on the Teneo Web Chat window state.
